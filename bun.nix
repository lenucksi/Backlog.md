# Set of Bun packages to install
{
  ...
  "@chevrotain/cst-dts-gen" = {
    ...
    name = "@chevrotain/cst-dts-gen@12.0.0";
  ...
  "@chevrotain/regexp-to-ast" = {
    ...
    name = "@chevrotain/regexp-to-ast@12.0.0";
